...
const TodoCard = () => {
  ...
  return (
    <div className=" md:w-2/3 text-white border-2 border-[#7B7B7B] rounded-xl  shadow-2xl flex flex-col  md:flex-row justify-between px-10 md:py-8 gap-2 py-3 items-center">
